...
type MatchTab = 'all' | 'best' | 'nearby' | 'new';

interface ArtisanMatch {
  id: string;
  badge: string;
  badgeType: 'best' | 'quality' | 'price' | 'nearby';
  name: string;
  business: string;
  location: string;
  chips: string[];
...
const ARTISAN_MATCHES: ArtisanMatch[] = [
  {
    id: '1',
    badge: 'Best Match',
    badgeType: 'best',
...
export default function SmartMatchResultsScreen() {
  ...
  const [inquirySentArtisan, setInquirySentArtisan] = useState<string | null>(null);

  const getBadgeStyle = (type: ArtisanMatch['badgeType']) => {
    switch (type) {
      case 'best':
  ...
  const handleSendInquiry = (artisan: ArtisanMatch) => {
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        <View style={styles.contextCard}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push({ pathname: '/buyer/requirement-review' as any })}
          >
                  ...
                  <View style={styles.cardRightCol}>
                    ...
                    <View style={styles.cardActionsCol}>
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          router.push({ pathname: '/artisan/business-page' as any })
                        }
                        activeOpacity={0.7}
                      >
        ...
        <View style={styles.refineCard}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push({ pathname: '/buyer/requirement-creator' as any })}
          >
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity
          ...
          onPress={() => router.push({ pathname: '/buyer/home' as any })}
          activeOpacity={0.7}
        >
        ...
        <TouchableOpacity
          style={styles.navItem}
          onPress={() => router.push({ pathname: '/artisan/buyer-opportunities' as any })}
          activeOpacity={0.7}
        >
