      ...
      >
        ...
        <View style={styles.sectionHeader}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push({ pathname: '/buyer/smart-match' as any })}
          >
            <Text style={styles.viewAllText}>View All</Text>
            <ArrowRight size={12} color={colors.studioTerracotta} />
          </TouchableOpacity>
          ...
          {ARTISANS.map((art) => (
            <View key={art.id} style={styles.artisanCard}>
              ...
              <TouchableOpacity
                ...
                onPress={() => router.push({ pathname: '/artisan/business-page' as any })}
              >
        ...
        <View style={styles.oppsList}>
          ...
          <TouchableOpacity
            ...
            onPress={() => router.push({ pathname: '/artisan/rfq-detail' as any })}
            activeOpacity={0.7}
          >
