...
export default function RFQDetailScreen() {
  ...
  const params = useLocalSearchParams<{ title?: string; buyer?: string; quantity?: string }>();
  ...
  const handleSendQuote = () => {
    router.push({
      pathname: '/artisan/send-quotation' as any,
      params: {
        title: rfqTitle,
        buyer: rfqBuyer,
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <View style={styles.bottomNav}>
        <TouchableOpacity
          ...
          onPress={() => router.push({ pathname: '/(artisan-tabs)' as any })}
          activeOpacity={0.7}
        >
        ...
        <TouchableOpacity
          style={styles.navFab}
          onPress={() => router.push({ pathname: '/artisan/image-studio' as any })}
          activeOpacity={0.8}
        >
