...
export default function SendQuotationScreen() {
  ...
  const [details, setDetails] = useState(
    'We will provide high-quality handcrafted terracotta mugs with traditional Indian designs and matte finish. Custom branding is possible as per your requirement.'
  );
          ...
          <View style={styles.modalContent}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                ...
                router.push({ pathname: '/artisan/buyer-opportunities' as any });
              }}
            >
