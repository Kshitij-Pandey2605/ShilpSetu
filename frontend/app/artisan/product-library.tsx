...
export default function ProductLibraryScreen() {
  ...
  const handleProductPress = (product: Product) => {
    router.push({
      pathname: '/artisan/product-detail' as any,
      params: {
        id: product.id,
        title: product.title,
  ...
  const handleAddProduct = () => {
    router.push({ pathname: '/artisan/image-studio' as any });
  };
  ...
  return (
    <SafeAreaView style={s.container} edges={['top']}>
      ...
      <View style={s.bottomNav}>
        <TouchableOpacity style={s.navItem} onPress={() => router.push({ pathname: '/(artisan-tabs)' as any })} activeOpacity={0.7}>
