...
export default function CapabilityProfileScreen() {
  ...
  // Selected tab
  const [activeTab, setActiveTab] = useState<'Overview' | 'Products' | 'Reviews' | 'Gallery'>('Overview');
  // Save artisan toggle
  ...
  const handleContinueToPriceAssistant = () => {
    ...
    router.push({
      pathname: '/artisan/price-assistant' as any,
      params: {
        artisanName: 'Savita Kumari',
        craft: (params.craft as string) || 'Terracotta Pottery',
    ...
    <SafeAreaView style={styles.safeArea} edges={['top', 'left', 'right']}>
      ...
      >
          ...
          <View style={styles.heroTopRow}>
            ...
            <View style={styles.heroMetaCol}>
              ...
              <Text style={styles.artisanCategory}>
                {(params.category as string) || 'Terracotta & Clay Crafts'}
              </Text>

              <View style={styles.locationRow}>
                <MapPin size={13} color={colors.studioTerracotta} style={{ marginRight: 4 }} />
                <Text style={styles.locationText}>
                  {(params.origin as string) || 'Jaipur, Rajasthan'}
                </Text>
              </View>
            </View>
          </View>
        ...
        <View style={styles.tabsRow}>
          {(['Overview', 'Products', 'Reviews', 'Gallery'] as const).map((tab) => {
